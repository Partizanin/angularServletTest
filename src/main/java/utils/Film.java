...
public class Film {
    ...
    public Film(String name, String originalName, int rates, String[] genres, String url) {
        this.name = name;
        this.url = url;
    ...
    private void initializeFromJsonObject(JSONObject object) {
        ...
        JSONArray jsonArray2 = (JSONArray) object.get("countries");

        String[] countries = new String[jsonArray2.length()];

        for (int i = 0; i < jsonArray2.length(); i++) {
            countries[i] = (String) jsonArray2.get(i);
        }
        ...
        this.imageUrl = (String) object.get("imageUrl");
